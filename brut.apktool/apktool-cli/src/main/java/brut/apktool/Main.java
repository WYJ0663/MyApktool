...
public class Main {
    ...
    private static void cmdBuild(CommandLine cli) throws BrutException {
        ...
        if (cli.hasOption("use-aapt2-compile")) {
            apkOptions.useAapt2Compile = true;
            apkOptions.aapt2CompilePath = cli.getOptionValue("use-aapt2-compile");
        }

        if (cli.hasOption("use-aapt2-link")) {
            apkOptions.useAapt2Link = true;
            apkOptions.aapt2CompilePath = cli.getOptionValue("use-aapt2-link");
        }
